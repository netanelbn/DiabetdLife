...
public class graph extends Activity implements OnTouchListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnCapture.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                //make a new table calld picture table
                ParseObject gameScore = new ParseObject("Pictures");
                //in the raw email we put the emailid of the user
                ...
                try
                {
                    ...
                    //save the data in row image in the table picture in PARSE
